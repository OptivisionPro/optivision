...
![IES Logo](https://raw.githubusercontent.com/OptivisionPro/optivision/gh-pages/assets/IES.png)
...
👉 [Visita aquí nuestra página web](https://optivisionpro.github.io/optivision/) 👈

La página web del proyecto ***está en desarrollo*** y servirá como *portal central* para acceder a la documentación, novedades y soporte técnico de OptiVision. Será un recurso clave para usuarios y administradores del sistema.


## Anexos

### 📎Anexo 1: **[Presentacion del equipo de OptiVision y del proyecto](./anexos/anexo1.pdf)**

- **Descripción General:** OptiVision es una empresa especializada en el mantenimiento de servidores de videojuegos.

- **Áreas de Especialización del Equipo:**
...
- **Fortalezas de OptiVision:**
  - Enfoque en la calidad del servicio.
  - Atención al cliente de alto nivel.
  - Soluciones innovadoras y eficientes para optimizar la     - experiencia de juego.

- **Visión Futura:** Expansión en el mercado y adaptación a las tendencias emergentes en la industria de los videojuegos.

### 📎Anexo 2: **[Descripción del Proyecto OptiVision](./anexos/anexo2.pdf)**

- **Descripción:** Empresa argentina dedicada a servidores.
- **Cliente:** Activision Argentina.
- **Objetivo:** Mejorar rendimiento, reducir lag y ping.
- **Ubicación:** Servidores en Mendoza.
- **Tecnología:** De última generación.
- **Cumplimiento:** Normativas legales y ambientales.
...
Para más información sobre el proyecto OptiVision, puedes contactarnos a través de [Email](mailto:hugod.ies9012@gmail.com)
o visitar nuestra [página web](https://optivisionpro.github.io/optivision/) (en desarrollo).
...
Queremos hacer una mención a dos personas que contribuyeron al proyecto pero que ya no forman parte del equipo académico:
